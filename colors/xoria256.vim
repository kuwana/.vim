...
hi WarningMsg	cterm=bold	ctermfg=196	ctermbg=none	gui=bold	guifg=#ff0000	guibg=bg
hi ModeMsg	cterm=bold	ctermfg=fg	ctermbg=none	gui=bold	guifg=fg	guibg=bg
hi MoreMsg	cterm=bold	ctermfg=250	ctermbg=none	gui=bold	guifg=#bcbcbc	guibg=bg
hi Question	cterm=bold	ctermfg=113	ctermbg=none	gui=bold	guifg=#87df7f	guibg=bg
...
hi SignColumn	cterm=none	ctermfg=248	ctermbg=none	gui=none	guifg=#a8a8a8	guibg=bg

hi Directory	cterm=none	ctermfg=39	ctermbg=none	gui=none	guifg=#00afff	guibg=bg
...
hi VisualNOS	cterm=bold,underline ctermfg=247 ctermbg=none	gui=bold,underline guifg=#9e9e9e guibg=bg

hi Comment	cterm=none	ctermfg=244	ctermbg=none	gui=none	guifg=#808080	guibg=bg
""" COLD
hi Constant	cterm=none	ctermfg=187	ctermbg=none	gui=none	guifg=#dfdfaf	guibg=bg
""" COLD-DARK
"hi Constant	cterm=none	ctermfg=223	ctermbg=none	gui=none	guifg=#ffdfaf	guibg=bg
""" NEUTRAL
"hi Constant	cterm=none	ctermfg=229	ctermbg=none	gui=none	guifg=#ffffaf	guibg=bg
""" WARM
"hi Constant	cterm=none	ctermfg=222	ctermbg=none	gui=none	guifg=#ffdf87	guibg=bg
"hi String	cterm=		ctermfg=	ctermbg=	gui=		guifg=		guibg=
hi Error	cterm=none	ctermfg=196	ctermbg=none	gui=none	guifg=#ff0000	guibg=bg
""" COLD
"hi Identifier	cterm=none	ctermfg=115	ctermbg=none	gui=none	guifg=#87dfaf	guibg=bg
""" NEUTRAL
"hi Identifier	cterm=none	ctermfg=114	ctermbg=none	gui=none	guifg=#87df87	guibg=bg
""" WARM
hi Identifier	cterm=none	ctermfg=150	ctermbg=none	gui=none	guifg=#afdf87	guibg=bg
hi Ignore	cterm=none	ctermfg=238	ctermbg=none	gui=none	guifg=#444444	guibg=bg
hi Number	cterm=none	ctermfg=180	ctermbg=none	gui=none	guifg=#dfaf87	guibg=bg
"hi Number	cterm=none	ctermfg=222	ctermbg=none	gui=none	guifg=#ffaf87	guibg=bg
"hi Number	cterm=none	ctermfg=215	ctermbg=none	gui=none	guifg=#ffaf87	guibg=bg
...
hi PreProc	cterm=none	ctermfg=182	ctermbg=none	gui=none	guifg=#dfafdf	guibg=bg
"hi PreProc	cterm=none	ctermfg=218	ctermbg=none	gui=none	guifg=#ffafdf	guibg=bg
""" LIGHT
"hi Special	cterm=none	ctermfg=174	ctermbg=none	gui=none	guifg=#ffafaf	guibg=bg
""" DARK
hi Special	cterm=none	ctermfg=174	ctermbg=none	gui=none	guifg=#df8787	guibg=bg
"hi Special	cterm=none	ctermfg=114	ctermbg=none	gui=none	guifg=#87df87	guibg=bg
"hi SpecialChar	cterm=		ctermfg=	ctermbg=	gui=		guifg=		guibg=
hi Statement	cterm=none	ctermfg=74	ctermbg=none	gui=none	guifg=#5fafdf	guibg=bg
"hi Statement	cterm=none	ctermfg=75	ctermbg=none	gui=none	guifg=#5fafff	guibg=bg
hi Todo		cterm=none	ctermfg=0	ctermbg=184	gui=none	guifg=#000000	guibg=#dfdf00
"hi Type		cterm=none	ctermfg=153	ctermbg=none	gui=none	guifg=#afdfff	guibg=bg
hi Type		cterm=none	ctermfg=146	ctermbg=none	gui=none	guifg=#afafdf	guibg=bg
hi Underlined	cterm=underline	ctermfg=39	ctermbg=none	gui=underline	guifg=#00afff	guibg=bg
...
if v:version >= 700
  ...
  hi TabLineSel	cterm=bold	ctermfg=fg	ctermbg=none	gui=bold	guifg=fg	guibg=bg
